...
const createAddr = asyncHandler(async (req, res) => {
    ...
    if (!latitude || !longitude) {
        throw new BetterError("Latitude and longitude are required", 400, "BAD_REQUEST", "User Error");
    }
    if (!Id) {
    ...
    try {
        ...
        throw new BetterError("Address not created", 500, "ADDRESS_NOT_CREATED", "User Error");
    }
});
