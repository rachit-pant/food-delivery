...
const getFranchiseOfStaff = expressAsyncHandler(async (req, res) => {
    ...
    if (!staff) {
        throw new BetterError("Staff record not found", 404, "STAFF_NOT_FOUND", "User Error");
    }
...
export default getFranchiseOfStaff;
