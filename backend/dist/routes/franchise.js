...
import { getStaff, StaffNotFranchise, } from '../controllers/franchise/exisitngStaffFranchise.js';
...
import { getFranchise, getSelectedRestaurants, } from '../controllers/franchise/getFranchise.js';
...
router.delete('/deleteFranchiseStaff/:franchiseStaffId', authorize, deleteFranchiseStaff);
