...
const MerchantGetRestro = asyncHandler(async (req: Request, res: Response) => {
...
const MerchantGetMenus = asyncHandler(async (req: Request, res: Response) => {
...
module.exports = { MerchantGetRestro, MerchantGetMenus };
